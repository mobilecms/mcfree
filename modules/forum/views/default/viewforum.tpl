...
<div class="title"><img src="<?php echo URL ?>views/<?php echo THEME ?>/img/titl.gif" class="ico" alt="" /><?php if($_GET['type'] != 'new'): ?><a href="<?php echo a_url('forum', 'section_id='. $section['section_id']) ?>"><?php echo $section['name'] ?></a> | <?php echo $forum['name'] ?><?php else: ?>Новые темы<?php endif; ?></div>
