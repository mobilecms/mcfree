...
<?php if($messages): ?>
	...
	<div class="menu">
        <?php echo user::get_icon($message['user_id']) ?> <?php echo user::get_username($message['user_id'], TRUE) ?> <?php echo user::online_status($message['last_visit']) ?> (<?php echo main::display_time($message['time']) ?>) [<a href="<?php echo a_url('guestbook/listing', 'reply='. $message['username']) ?>">Отв</a>]<br />
