...
<div class="title"><img src="<?php echo URL ?>views/<?php echo THEME ?>/img/titl.gif" class="ico" alt="" /><b>Форум</b></div>
...
<?php if($sections): ?>
	...
	<div class="menu">
	<img src="<?php echo URL ?>views/<?php echo THEME ?>/img/icon.png" alt="" /> <a href="<?php echo a_url('forum', 'section_id='. $section['section_id']) ?>"><?php echo $section['name'] ?></a>
	</div>
