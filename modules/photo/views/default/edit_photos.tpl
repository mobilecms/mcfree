...
<div class="title"><img src="<?php echo URL ?>views/<?php echo THEME ?>/img/titl.gif" class="ico" alt="" /><b><a href="<?php echo a_url('photo/list_photos', 'album_id='. $album['album_id'] .'&amp;user_id='. $user_id); ?>"><?php echo $album[name] ?></a></b> | <b><?php echo $title ?></b></div>
