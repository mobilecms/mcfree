...
function avatar($user_id) {
	if (file_exists(ROOT .'files/avatars/'. $user_id .'_100'. '.png')) return '<img src="'. URL .'files/avatars/'. $user_id .'_100.png' .'" alt="" /><br />';
	elseif (file_exists(ROOT .'files/avatars/'. $user_id .'_100'. '.gif')) return '<img src="'. URL .'files/avatars/'. $user_id .'_100.gif' .'" alt="" /><br />';
	elseif (file_exists(ROOT .'files/avatars/'. $user_id .'_100'. '.jpg')) return '<img src="'. URL .'files/avatars/'. $user_id .'_100.jpg' .'" alt="" /><br />';
	elseif (file_exists(ROOT .'files/avatars/'. $user_id .'_100'. '.jpeg')) return '<img src="'. URL .'files/avatars/'. $user_id .'_100.jpeg' .'" alt="" /><br />';
}
